            ...
            serviceMovie.getMovies().enqueue(new Callback<List<MoviesResponse>>() {
                ...
                public void onResponse(Call<List<MoviesResponse>> call, Response<List<MoviesResponse>> response) {
                    if(response.isSuccessful()){
                        ...
                        Toast.makeText(ChatList.this, "ПРоизошла ошибка", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(ChatList.this, "Произошла неизвестная ошибка", Toast.LENGTH_SHORT).show();
                    }
                }
